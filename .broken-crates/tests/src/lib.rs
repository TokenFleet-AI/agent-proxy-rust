...
#[must_use]
pub fn anthropic_response(id: &str, text: &str, input_tokens: u64, output_tokens: u64) -> serde_json::Value {
    serde_json::json!({
        "id": id,
        "type": "message",
        "role": "assistant",
...
#[must_use]
pub fn openai_response(id: &str, text: &str, input_tokens: u64, output_tokens: u64) -> serde_json::Value {
    serde_json::json!({
        "id": id,
